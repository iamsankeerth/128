...
Application materials stored in this repo with role-based filenames and direct GitHub links.

| Company | Role | Candidate | Folder | Score |
|---------|------|-----------|--------|-------|
...
| Xclusive Interiors | AI Specialist / AI Generalist | Sankeerth Masetty | [xclusive-interiors/ai-specialist-sankeerth/](xclusive-interiors/ai-specialist-sankeerth/) | 3.5/5* |

\*Skills fit 4.0/5; overall lowered due to ₹20–30k/month comp vs other targets.
